...
interface TokenInterface
{
    ...
    /**
     * Returns TRUE if \Neos\Security\RequestPattern were set
     *
     * @return boolean True if a \Neos\Security\RequestPatternInterface was set
     */
     ...
     *
     * @param array $requestPatterns Array of \Neos\Security\RequestPatternInterface to be set
     * @return void
