...
use Neos\Security\Exception\NoAuthenticationProviderFoundException;
...
class AuthenticationProviderResolver
{
    ...
    public function resolveProviderClass($providerName)
    {
        ...
        $resolvedObjectName = $this->objectManager->getCaseSensitiveObjectName('Neos\Security\Authentication\Provider\\' . $providerName);
        if ($resolvedObjectName !== false) {
            return $resolvedObjectName;
        }
