...
use Neos\Security\Authentication\Token\PasswordToken;
use Neos\Security\Authentication\TokenInterface;
use Neos\Security\Cryptography\FileBasedSimpleKeyService;
 ...
 * Neos\Security\Authentication\Token\PasswordToken tokens.
