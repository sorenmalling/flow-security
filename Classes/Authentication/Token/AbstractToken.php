<?php
namespace Neos\Security\Authentication\Token;
...
use Neos\Security\Authentication\EntryPointInterface;
use Neos\Security\Authentication\TokenInterface;
use Neos\Security\Exception\InvalidAuthenticationStatusException;
...
abstract class AbstractToken implements TokenInterface
{
    ...
    /**
     * Returns an array of set \Neos\Security\RequestPatternInterface, NULL if none was set
     *
     * @return array<\Neos\Security\RequestPatternInterface> Array of set request patterns
    ...
    /**
     * Sets the authentication status. Usually called by the responsible \Neos\Security\Authentication\AuthenticationManagerInterface
     *
