<?php
namespace Neos\Security\Policy;
...
use Neos\Security\Authorization\Privilege\Parameter\PrivilegeParameterDefinition;
use Neos\Security\Authorization\Privilege\PrivilegeTarget;
use Neos\Security\Exception\NoSuchRoleException;
use Neos\Security\Exception as SecurityException;
use Neos\Security\Authorization\Privilege\PrivilegeInterface;
...
class PolicyService
{
    ...
    protected function initialize()
    {
        ...
        $this->roles = [];
        $everybodyRole = new Role('Neos.Security:Everybody');
        ...
        $this->roles['Neos.Security:Everybody'] = $everybodyRole;
