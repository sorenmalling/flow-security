<?php
namespace Neos\Security\Authorization\Privilege;
...
use Neos\Security\Authorization\Privilege\Parameter\PrivilegeParameterInterface;
use Neos\Security\Exception\InvalidPrivilegeTypeException;
...
interface PrivilegeInterface extends CacheAwareInterface
{
    ...
    /**
     * Unique name of the related privilege target (for example "Neos.Security:PublicMethods")
     *
     * @return string
     */
