<?php
namespace Neos\Security\Authorization\Privilege\Entity\Doctrine;
...
use Neos\Security\Authorization\Privilege\AbstractPrivilege;
use Neos\Security\Authorization\Privilege\Entity\EntityPrivilegeInterface;
use Neos\Security\Authorization\Privilege\PrivilegeSubjectInterface;
use Neos\Security\Exception\InvalidQueryRewritingConstraintException;
