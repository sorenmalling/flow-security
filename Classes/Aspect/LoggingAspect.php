<?php
namespace Neos\Security\Aspect;
...
use Neos\Security\Authentication\AuthenticationManagerInterface;
...
class LoggingAspect
{
     ...
     *
     * @Flow\After("within(Neos\Security\Authentication\AuthenticationManagerInterface) && method(.*->authenticate())")
     ...
     *
     * @Flow\AfterReturning("within(Neos\Security\Authentication\AuthenticationManagerInterface) && method(.*->logout())")
     * @param JoinPointInterface $joinPoint The current joinpoint
     * @return mixed The result of the target method if it has not been intercepted
     */
     ...
     *
     * @Flow\AfterReturning("within(Neos\Security\Authentication\AuthenticationProviderInterface) && method(.*->authenticate())")
     * @param JoinPointInterface $joinPoint The current joinpoint
     * @return mixed The result of the target method if it has not been intercepted
     */
     ...
     *
     * @Flow\After("method(Neos\Security\Authorization\Privilege\Method\MethodPrivilege->vote())")
     ...
     *
     * @Flow\After("method(Neos\Security\Authorization\PrivilegeManager->isPrivilegeTargetGranted())")
     * @param JoinPointInterface $joinPoint
     * @return void
     */
