...
use Neos\Security\Authorization\Interceptor\PolicyEnforcement;
...
class PolicyEnforcementAspect
{
     ...
     *
     * @Flow\Around("filter(Neos\Security\Authorization\Privilege\Method\MethodPrivilegePointcutFilter)")
