<?php
namespace Neos\Security\Cryptography;
...
use Neos\Security\Exception\DecryptionNotAllowedException;
use Neos\Security\Exception\InvalidKeyPairIdException;
use Neos\Security\Exception\MissingConfigurationException;
